        ...
        <div className="user-profile">
            ...
            <Modal show={showSettings} onHide={handleCloseSettings}>
                <Modal.Header closeButton>
                    <Modal.Title>Настройки профиля</Modal.Title>
                </Modal.Header>
                <Modal.Body>
                    <Form>
                        <Form.Group controlId="formEmail">
                            <Form.Label>Email (временно недоступно)</Form.Label>
                            <Form.Control type="email" value={email} placeholder="" readOnly disabled />
                        </Form.Group>
                ...
                <Modal.Footer id='modal-prof'>
                        <Form.Group controlId="formLanguageToggle">
                            <div className="language-buttons">
                                <Button 
                                    variant={language === 'ru' ? 'primary' : 'outline-primary'} 
